...
class UpdateBadgeRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'name_ar' => ['required', 'string', 'max:255', Rule::unique('badges', 'name->ar')->ignore($id)],
            'name_en' => ['required', 'string', 'max:255', Rule::unique('badges', 'name->en')->ignore($id)],
            'description_en' => ['required', 'string', Rule::unique('badges', 'description->en')->ignore($id)],
            'description_ar' => ['required', 'string', Rule::unique('badges', 'description->ar')->ignore($id)],
