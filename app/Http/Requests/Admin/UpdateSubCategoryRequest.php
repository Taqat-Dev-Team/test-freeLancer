...
class UpdateSubCategoryRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'name_ar' => ['required', 'string', 'max:255', Rule::unique('sub_categories', 'name->ar')->ignore($id)],
            'category_id' => ['required', 'exists:categories,id'],
            'name_en' => ['required', 'string', 'max:255', Rule::unique('sub_categories', 'name->en')->ignore($id)],
        ];
    }
